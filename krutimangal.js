...
var krutitextId = document.getElementById("krutitext");
var mangaltextId = document.getElementById("mangaltext");

function krutitomangal(outputId = "") {
  var text_size = krutitextId.value.length;
  var kruti_array_length = kruti_array.length;
  var kruti_text = krutitextId.value;
  ...
  while (r == 1) {
    ...
    if (o < text_size - max_text_size) {
      o += max_text_size;
      while (krutitextId.value.charAt(o) != " ") {
        o--;
      }
    } else {
      o = text_size;
    ...
    var kruti_text = krutitextId.value.substring(n, o);

    replsym();

    processed_text += kruti_text;
    if (outputId === "") {
      krutitextId.value = processed_text;
    } else {
      document.getElementById(outputId).value = processed_text;
    }
  }
...
function copyclipboard(outputId = "") {
  if (outputId === "") {
    var copyText = krutitextId;
  } else {
